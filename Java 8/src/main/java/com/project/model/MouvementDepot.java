...
public class MouvementDepot {
    ...
    // Constructeurs
    public MouvementDepot() {}

    public MouvementDepot(int idMouvement, int idPersonne, double montantEntrer, double montantSortie, LocalDateTime dateMouvement) {
    ...
    public double getMontantEntrer() { return montantEntrer; }
    public void setMontantEntrer(double montantEntrer) { this.montantEntrer = montantEntrer; }

    public double getMontantSortie() { return montantSortie; }
    public void setMontantSortie(double montantSortie) { this.montantSortie = montantSortie; }
